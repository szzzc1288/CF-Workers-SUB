...
let mytoken = 'cyzzc'; //可以随便取，或者uuid生成，https://1024tools.com/uuid
...
let urls = [];
let subconverter = "sub.szzzc.link"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
